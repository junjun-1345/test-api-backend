...
func NewRouter(tagsController *controller.TagsController, worksController *controller.WorksController, shiftsController *controller.ShiftController, userController *controller.UserController) *gin.Engine {
	//ルーター関連・初期化
	router := gin.Default()
